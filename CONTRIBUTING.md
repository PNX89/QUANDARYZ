...
- types and the subjects, in a simulated DOM
- the counterexample, in real Chromium
...
https://pnx89.github.io/QUANDARYZ, come from a real run whose output is committed under
